const CMClient = require('./CMClientProxy');
...
class Bot extends EventEmitter {
    ...
    constructor(settings) {
        ...
        // proxy: CMClient代理，将 connect(server) 的 server 改为从 servers.json 选择
        // 原本重连时是从steam官网获取CMList，然后随机选择一个
        // https://api.steampowered.com/ISteamDirectory/GetCMList/v1/?format=json&cellid=0
        var proxy = new CMClient(this.settings.steam_user);
        this.steamClient = new SteamUser(proxy, Object.assign({
